...
if(IS_DIRECTORY $ENV{TENSORFLOW_BUILD_DIR})
  set(TensorFlow_BUILD_DIR "$ENV{TENSORFLOW_BUILD_DIR}" CACHE PATH "directory containing the file 'libtensorflow_cc.so'")
else()
  if(NOT IS_DIRECTORY ${TensorFlow_BUILD_DIR})
    set(TensorFlow_BUILD_DIR "TensorFlow_BUILD_DIR-NOTFOUND" CACHE PATH "directory containing the file 'libtensorflow_cc.so'")
  endif()
endif()
