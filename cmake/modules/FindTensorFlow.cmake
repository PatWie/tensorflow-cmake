...
if(TensorFlow_FOUND)
  ...
  FOREACH(_TensorFlow_VER ${_TensorFlow_TEST_VERSIONS})
    if("${TF_DETECTED_VERSION_MAJOR}.${TF_DETECTED_VERSION_MINOR}" STREQUAL "${_TensorFlow_VER}")
      ...
      message(STATUS "TF_FIND_VERSION_MINOR is ${TF_FIND_VERSION_MINOR}")
      message(STATUS "TF_FIND_VERSION_MAJOR is ${TF_FIND_VERSION_MAJOR}")
      message(STATUS "TF_DETECTED_VERSION_MAJOR is ${TF_DETECTED_VERSION_MAJOR}")
      message(STATUS "TF_DETECTED_VERSION_MINOR is ${TF_DETECTED_VERSION_MINOR}")
